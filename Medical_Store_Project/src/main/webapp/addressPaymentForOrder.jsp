...
<div class="right-div">
<h3>Pay online on this xyz358@ybl.com </h3>
<input class="input-style" type="text" name="transactionId"  placeholder="Enter Transaction ID" required>
<h3 style="color: aqua">*If you select online Payment then enter you transaction ID here otherwise leave this blank</h3>
</div>
<hr style="width: 100%">
